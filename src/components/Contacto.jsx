...
export default function Contacto({ data }) {
  return (
    <section id="contacto" className="py-16 bg-gradient-to-br from-blue-50 via-green-50 to-violet-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <a
            ...
            className="bg-gradient-to-br from-violet-50 to-blue-50 p-8 rounded-lg text-center hover:shadow-lg transition-shadow duration-200 group"
          >
            <MessageCircle className="mx-auto text-violet-600 group-hover:text-violet-500 transition-colors mb-4" size={48} />
